(() => {
  ...
  // ns-hugo:/Users/nao.deng/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/krisk/!fuse@v7.0.0+incompatible/dist/fuse.js
  var require_fuse = __commonJS({
    "ns-hugo:/Users/nao.deng/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/krisk/!fuse@v7.0.0+incompatible/dist/fuse.js"(exports, module) {
  ...
  // ns-hugo:/Users/nao.deng/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.13.3/assets/search/js/dropdown.ts
  (() => {
    const hide = (dropdown) => {
  ...
  // ns-hugo:/Users/nao.deng/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.13.3/assets/search/js/keyboard.ts
  var Keyboard = class {
    keys = {};
    events = [];
  ...
  // ns-hugo:/Users/nao.deng/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.13.3/assets/search/js/navigator.ts
  var Navigator = class {
    modal() {
  ...
  // ns-hugo:/Users/nao.deng/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.13.3/assets/search/js/i18n.ts
  var i18n = new Translator(params_default.i18n, params_default.defaultLang);
  var i18n_default = i18n;

  // ns-hugo:/Users/nao.deng/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.13.3/assets/search/js/engine.ts
  ...
  // ns-hugo:/Users/nao.deng/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.13.3/assets/search/js/historiographer.ts
  var Historiographer = class {
    ...
    get() {
      ...
      return histories.slice(0, params_default.historiesCount);
    }
    save(query) {
      if (query === "") {
        return;
      ...
      if (histories.length > params_default.historiesCount) {
        histories.pop();
      }
  ...
  // ns-hugo:/Users/nao.deng/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.13.3/assets/search/js/form.ts
  var Form = class {
  ...
  <div class="search-input-group-wrapper">
    <div class="search-input-group">
        ...
        <input type="search" name="q" class="search-input search-form-control" placeholder="${i18n_default.translate("input_placeholder")}" autocomplete="off" disabled/>
        <button class="search-reset-button disabled" type="reset">${params_default.icons["reset"]}</button>
    </div>
  ...
  <div class="search-form-meta">
    ...
    renderLanguage() {
      if (Object.keys(params_default.langs).length < 2) {
        return "";
      }
  ...
  <ul class="search-dropdown-menu">
    ...
    submit() {
      ...
      engine_default.search(query, sorting, lang, years, taxonomies).then(({ results, time }) => {
        ...
        if (params_default.histories) {
          historiographer_default.save(query);
        }
        this.spinner.hide();
      });
    }
  ...
  // ns-hugo:/Users/nao.deng/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.13.3/assets/search/js/spinner.ts
  var Spinner = class {
    constructor(ele) {
      this.ele = ele;
    }
  ...
  // ns-hugo:/Users/nao.deng/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.13.3/assets/search/js/renderer.ts
  var Renderer = class {
  ...
  // ns-hugo:/Users/nao.deng/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.13.3/assets/search/js/shortcuts.ts
  var Navigate = {
    kbds: ["\u2191", "\u2193"],
...
<span class="search-shortcut-action">${shortcut["action"]}</span>
  ...
  // ns-hugo:/Users/nao.deng/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.13.3/assets/search/js/modal.ts
  var searchShortcut = {
  ...
  // ns-hugo:/Users/nao.deng/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.13.3/assets/search/js/search.ts
  var Search = class {
    container;
    form;
    shortcuts;
